...
export class ColourPalette {
    ...
    loadColours() {
        ...
        colorPicker.on(['color:init', 'color:change'], (color) => {
            ...
            this.colourPaletteElement.style(
                'background-color',
                color.hexString
            );
        });
        ...
        this.colourPaletteElement.mouseClicked(() => {
            ...
            if (this.colourPickerElement.hasClass('hidden')) {
                ...
                this.colourPickerElementRect =
                    this.colourPickerElement.elt.getBoundingClientRect();
            }
        });
    }
    ...
    isAllowedToDraw() {
        ...
        return !(
            this.p.winMouseX >= this.colourPickerElementRect.left &&
            this.p.winMouseX <= this.colourPickerElementRect.right &&
            this.p.winMouseY >= this.colourPickerElementRect.top &&
            this.p.winMouseY <= this.colourPickerElementRect.bottom
        );
    }
}
